...
do
    ...
    few_shot_output_dir="${dataset}/${num_shots}-shots/${seed}"
    train_command+=" --output-dir /projects/leelab/clin25/cocoop-output/${few_shot_output_dir}"
