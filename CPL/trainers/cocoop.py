...
import sys
sys.path.append("..")
from trainers import prompters
...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.dtype = clip_model.dtype
        # prompt_size, image_size = 30, 224
        # self.prompter = prompters.__dict__['padding'](prompt_size, image_size)
...
class CoCoOp(TrainerX):
    ...
    def build_model(self):
        ...
        # self.optim1 = build_optimizer(self.model.prompter, cfg.OPTIM)
